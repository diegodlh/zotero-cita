...
`;
  ...
  // package.json
  var config = {
    addonName: "Zotero Cita",
    addonID: "zotero-wikicite@wikidata.org",
    addonRef: "zotero-wikicite",
    addonInstance: "ZoteroCita",
    prefsPrefix: "extensions.cita",
    releasePage: "https://github.com/diegodlh/zotero-cita/releases",
    updateJSON: "https://github.com/diegodlh/zotero-cita/releases/latest/download/update.json"
  };
  ...
  // src/cita/wikiciteChrome.ts
  var WikiciteChrome = class _WikiciteChrome {
    static {
      this.XULRootElements = [];
    }
    static {
      this.init = function() {
        window.setTimeout(function() {
          if (typeof _WikiciteChrome != "undefined") {
            _WikiciteChrome.showUpgradeMessage();
          }
        }, 500);
      };
    }
    static {
      this.showUpgradeMessage = function() {
      };
    }
    static {
      /******************************************/
    ...
    static {
      ...
      this.registerXUL = function(elementIDs, doc) {
        if (typeof doc.WikiciteXULRootElements == "undefined") {
          doc.WikiciteXULRootElements = [];
        }
        var xulRootElements;
        if (doc == document) {
          xulRootElements = _WikiciteChrome.XULRootElements;
        } else {
    ...
    static {
      ...
      this.removeXUL = function() {
        _WikiciteChrome.removeDocumentXUL(
          document,
          _WikiciteChrome.XULRootElements
        );
      };
    }
    static {
      this.removeDocumentXUL = function(doc, XULRootElementIDs) {
  ...
  var wikiciteChrome_default = WikiciteChrome;
  ...
  var Addon = class {
    constructor() {
      ...
      this.wikiciteChrome = wikiciteChrome_default;
      this.api = {};
    }
  };
