...
declare global {
    interface Document { WikiciteXULRootElements: string[]; }
}
...
class WikiciteChrome {
    ...
    static removeXUL = function() {
        WikiciteChrome.removeDocumentXUL(document, WikiciteChrome.XULRootElements);
    };

    static removeDocumentXUL = function(doc: Document, XULRootElementIDs: string[]) {
